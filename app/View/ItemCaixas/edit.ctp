...
<?php echo $this->Form->create('ItemCaixa'); ?>
	<fieldset>
		<legend><?php echo __('Edit Item Caixa'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ItemCaixa.n')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ItemCaixa.n'))); ?></li>
