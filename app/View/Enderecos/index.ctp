<div class="enderecos index">
	<h2><?php echo __('Enderecos'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('logradouro'); ?></th>
			<th><?php echo $this->Paginator->sort('tipo_logradouro_id'); ?></th>
	...
	<tr>
		<td><?php echo h($endereco['Endereco']['id']); ?>&nbsp;</td>
		...
		<td><?php echo h($endereco['Endereco']['complemento']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($endereco['Cidade']['nome_cidade'], array('controller' => 'cidades', 'action' => 'view', $endereco['Cidade']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $endereco['Endereco']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $endereco['Endereco']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $endereco['Endereco']['id']), null, __('Are you sure you want to delete # %s?', $endereco['Endereco']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
