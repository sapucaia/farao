<div class="items index">
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <th><?php echo $this->Paginator->sort('tipo_item_id'); ?></th>
        ...
        <?php foreach ($items as $item): ?>
            <tr>
                ...
                <td>
                    <?php echo $this->Html->link($item['TipoItem']['id'], array('controller' => 'tipo_items', 'action' => 'view', $item['TipoItem']['id'])); ?>
                </td>
                <td><?php echo h($item['Item']['nome']); ?>&nbsp;</td>
                <td><?php echo h($item['Item']['valor']); ?>&nbsp;</td>
                <td class="actions">
